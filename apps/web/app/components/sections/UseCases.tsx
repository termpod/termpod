...
function PhoneMockupSmall({ children, title }: { children: React.ReactNode; title: string }) {
  return (
    <div className="flex w-full max-w-[320px] flex-col border-2 border-stroke-light bg-[#0D1117]">
      <div className="flex items-center justify-between border-b border-stroke-light px-4 py-2">
        ...
        <div className="flex items-center gap-1.5 rounded-full bg-gold-subtle px-2 py-0.5">
          ...
          <span className="font-mono text-[8px] font-semibold tracking-wider text-gold">LIVE</span>
        </div>
      </div>
    ...
    >
      ...
      <div className="flex w-full flex-col overflow-hidden border border-stroke-light md:flex-row">
        ...
        <div className="flex flex-1 items-center justify-center bg-[#0A0A0A] p-6 md:max-w-[440px]">
          <Screenshot
            src="/screenshots/uc-migrate.png"
            alt="Database migration progress on iPhone"
            width={320}
            height={280}
          >
            <PhoneMockupSmall title="MIGRATION">
              ...
              <p className="text-text-gray">
                <span className="text-green-500">&#10003;</span> 20260317_add_users &nbsp;&nbsp;done
              </p>
              <p className="text-text-gray">
                <span className="text-green-500">&#10003;</span> 20260317_add_teams &nbsp;&nbsp;done
              </p>
              <p className="text-gold">&#9632; 20260317_add_billing &nbsp;67%</p>
            </PhoneMockupSmall>
          </Screenshot>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col-reverse overflow-hidden border border-stroke-light md:flex-row">
        <div className="flex flex-1 items-center justify-center bg-[#0A0A0A] p-6 md:max-w-[440px]">
          <Screenshot
            ...
            alt="Deploy confirmation prompt on iPhone"
            width={320}
            height={280}
          >
            <PhoneMockupSmall title="DEPLOY">
              ...
              <p className="text-text-gray">&nbsp;</p>
              <p className="text-yellow-400">&#9888; Deploy to PRODUCTION?</p>
              <p className="text-text-gray">This will affect 12,847 active users.</p>
              <p className="text-text-gray">&nbsp;</p>
              <p className="text-text-gray">
                Type <span className="text-text-white">&apos;yes&apos;</span> to confirm:
      ...
      <div className="flex w-full flex-col overflow-hidden border border-stroke-light md:flex-row">
        ...
        <div className="flex flex-1 items-center justify-center bg-[#0A0A0A] p-6">
          <Screenshot
            src="/screenshots/uc-monitor.png"
            alt="Server health check terminal"
            width={480}
            height={240}
          >
            <div className="w-full border border-stroke-light bg-[#0D1117]">
              <div className="flex h-7 items-center gap-2 border-b border-stroke-light bg-[#161B22] px-3">
                ...
                <span className="ml-2 font-mono text-[10px] text-text-dark">SERVER</span>
              </div>
              <div className="flex flex-col gap-0.5 p-4 font-mono text-[11px] leading-relaxed">
                <p>
                ...
                <p className="text-green-500">&#9679; nginx.service - active (running)</p>
                <p className="text-text-gray">&nbsp;</p>
                <p>
                  <span className="text-text-dark">root@web $</span>{' '}
                  <span className="text-gold">curl -s localhost/health</span>
                </p>
                <p className="text-text-gray">{`{"status":"ok","uptime":"14d","memory":"62%"}`}</p>
              </div>
            </div>
          </Screenshot>
        </div>
