...
export function FinalCTA() {
  return (
    <section id="download" className="px-6 py-16 md:px-20 md:py-24 lg:px-[120px] lg:py-[100px]">
      <div
        className="flex flex-col items-center border border-gold-dim p-10 text-center md:p-16"
        style={{
          background: 'linear-gradient(to bottom, rgba(201,169,98,0.06) 0%, transparent 100%)',
        }}
      >
        ...
        <p className="mb-10 max-w-[600px] font-mono text-sm leading-relaxed text-text-gray">
          Stop walking back to your desk. Start a session on your Mac and take it with you.
        </p>
