    ...
    <div className="modal-overlay" onClick={onClose} onKeyDown={handleKeyDown}>
      <div className="sd" onClick={(e) => e.stopPropagation()}>
        <div className="sd-header">
          <div className="sd-icon">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M6 10l4-4M6.5 6.5L5.1 5.1a2 2 0 010-2.83l.7-.7a2 2 0 012.83 0L10 2.9M9.5 9.5l1.4 1.4a2 2 0 010 2.83l-.7.7a2 2 0 01-2.83 0L6 13.1" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
            </svg>
          </div>
          <div>
            <div className="sd-title">Session Shared</div>
            <div className="sd-subtitle">
              Read-only access &middot; expires {remaining}
            </div>
          </div>
        </div>
        ...
        <div className="sd-link-row">
          ...
          />
          <button className={`sd-copy ${copied ? 'sd-copy-done' : ''}`} onClick={handleCopy} type="button">
            {copied ? (
